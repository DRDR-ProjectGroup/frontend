...
import "@/components/tiptap/tiptap-node/video-upload-node/video-upload-node.scss"
...
const VideoUploadDragArea: React.FC<VideoUploadDragAreaProps> = ({
  ...
  return (
    <div
      className={`tiptap-video-upload-drag-area ${isDragActive ? "drag-active" : ""} ${isDragOver ? "drag-over" : ""}`}
